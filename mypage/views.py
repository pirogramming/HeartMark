...
WEEKLY_EMOTION_MESSAGES = {
    "02": "사랑하기 딱 좋은 나이인데~ 좋은 사랑하세요~♥️",
    "07": "성공하시길… 응원합니다!",
    "01": "마음에 비가 내리네요… 그럴 땐 좋아하는 걸 해볼까요?",
    "06": "마음에 비가 내리네요… 그럴 땐 좋아하는 걸 해볼까요?",
    "10": "마음에 비가 내리네요… 그럴 땐 좋아하는 걸 해볼까요?",
    "13": "호~ 아프지 마세용!😢 건강 챙기기!",
    "16": "당신이 행복하면 저도 행복해요",
    "05": "아주 나이스~!\n만족스러운 한 주였네요",
    "12": "엄지 엄지 척👍🏻\n언제까지 어깨춤을 추게 할거야~🎵",
...
def _build_insights(records):
    ...
    if weekly_emotion:
        weekly_message = WEEKLY_EMOTION_MESSAGES.get(
            weekly_emotion,
            "이번 주에는 이 마음을 가장 자주 남겼어요.\n내 마음을 천천히 돌아봐 주세요.",
        )
    else:
